...
# from problog.prolog_engine.extern import swi_problog_export_nondet
...
# @swi_problog_export_nondet('+term', '-term', '-list')
# def enum_groups(group_values, **kwargs):
#     group_values_l = term2list(group_values, False)
#
#     grouped = defaultdict(list)
#
...
#
#
# @swi_problog_export_nondet('+term', '+term', '-term', '-list')
# def enum_groups(groups, values, **kwargs):
#     groups_l = term2list(groups, False)
#     values_l = term2list(values, False)
#
#     grouped = defaultdict(list)
