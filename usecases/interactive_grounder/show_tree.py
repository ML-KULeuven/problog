...
function click(treenode) {
  if (treenode.children || treenode._children) {
    ...
    function callback(data) {
      ...
      // var result = data.content.user_expressions.out1.data['text/plain'];
      // var datas = JSON.parse(result.substr(1, result.length-2));
    
      // var c1 = {'name': datas[0], 'parent': treenode};
      // var c2 = {'name': datas[1], 'parent': treenode};
      // treenode.children = [c1, c2];
      // update(treenode);
    }
